...
void Personaje:: setVida( int vida ) {
    ...
    // Para que no se pueda exceder el maximo de vida inicial, o si el menor o igual a cero, que de una vez modifique el
...
bool Personaje::isPuedeEquiparObjeto() {
    ...
    return objetosEquipados.size() < 2; // si se cumple devuelve un true y si no devuelve un false
}
