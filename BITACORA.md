...
| 17/nov/2024 | Implementar ObjetoAsignado con sistema de efectos temporales | Separar la instancia de uso del tipo de objeto permite que cada héroe tenga su propia copia con estado independiente (usado/no usado, turnos restantes). | José |
| 17/nov/2024 | Crear los objetos mágicos (PactoSangriento, CaballaLegendaria, Revivir) | Cada objeto necesita su propia lógica de efecto. La herencia de ObjetoMagico permite polimorfismo y cada clase implementa aplicarEfecto() según su comportamiento único. | José |
...
| 26/nov/2025 | Agregar Paladin y HechiceroOscuro como roles adicionales | Se necesitaban más roles para dar variedad al combate. Paladín tiene habilidades de protección y Hechicero Oscuro hace daño a todos incluyendo aliados. | José |
...
| 30/nov/2025 | Implementar sistema de guardado de héroes vivos en archivos JSON | Permite persistir el estado de los héroes entre sesiones del juego. Los jugadores pueden guardar su progreso. | José |
